...
const Game: React.FC = () => {
	...
	// const [theme, setTheme] = useState<Theme>(Theme.BARN)
	// const [theme, setTheme] = useState<Theme>(Theme.FARM)
	// const [theme, setTheme] = useState<Theme>(Theme.BASKETBALL)
	...
	const handleChange = (event: SelectChangeEvent<number>, child: ReactNode) => {
		...
		} else if (event.target.value === Theme.BASKETBALL) {
			setTheme(Theme.BASKETBALL)
		} else if (event.target.value === Theme.FARM) {
			setTheme(Theme.FARM)
		} else if (event.target.value === Theme.BEACH) {
			setTheme(Theme.BEACH)
		} else if (event.target.value === Theme.NIGHT) {
	...
	return (
		<div>
			...
			<Select onChange={handleChange}
				...
				<MenuItem value={Theme.BASKETBALL}>Basketball</MenuItem>
