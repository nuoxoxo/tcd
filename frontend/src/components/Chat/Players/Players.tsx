...
const Players: React.FC<{
  ...
  function isAdmin(user: User): boolean {
    if (currentChat?.type == "PRIVATE") return false;
      ...
      <div className="add-block">
        ...
        {!isBlocked ? (
          <Button
            ...
            onClick={() => {
              handleBlock(enqueueSnackbar, user);
            }}
          >
            Block
          </Button>
          ...
          <Button
            ...
            className="action-button block"
            onClick={() => {
              handleUnblock(enqueueSnackbar, user);
            }}
          >
            Unblock
          </Button>
    ...
    return (
      <div className="buttons">
        ...
        {admin && !isAdmin(user) && (
          <Button
            variant="contained"
            className="action-button set-admin"
            onClick={() => {
              handlePromote(
                enqueueSnackbar,
                currentUser as User,
